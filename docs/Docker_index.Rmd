...
All the files that I use to configure the servers, including this web as well, are in the public repository: <https://github.com/reisikei/docker>   
...
Check out some recommended setups and projects (involving Docker as well) on <https://reisikei.github.io/RPi/>
